...
const ServiceAccordion = () => {
  const firstTwoItems = accordionData.slice(0, 2);
  const nextTwoItems = accordionData.slice(2, 4);
        ...
        >
          <div className="w-full lg:w-[49%] ">
            {firstTwoItems.map((item) => (
              <AccordionItem
                key={item.id}
                className={`border-b-[0] mb-[12px] rounded-[12px]
                  ...
                  <div className="pl-[46px] xl:pl-[74px] 2xl:pl-[84px]">
                   ...
                   text-dark font-bold leading-[130%]"
                    ...
                    <div className="hidden md:flex md:justify-end mt-4 ">
                      <button
                        className="flex justify-center items-center font-bold gap-[6px] 
                     text-[16px] p-[18px_32px] rounded-[100px] bg-btn-primary-gradient text-dark
                     hover:bg-btn-primary-gradient-hover"
                      >
                        {item.buttonlabel}
                        {item.buttonIcon}
                      </button>
