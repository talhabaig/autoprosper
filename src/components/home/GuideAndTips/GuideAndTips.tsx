    ...
    <section className="py-[3rem]  2xl:py-[4rem] 3xl:py-[6rem]  bg-dark-7">
      <div className="container">
        ...
        <div
          ...
          lg:gap-[1.125rem] 3xl:gap-[1.875rem] overflow-x-auto  ${styles.customScrollBar}`}
        >
          {cardData.map((item, index) => (
            <div
              key={item.id}
              className="flex-grow max-w-[215px] w-full xl:w-[22%] xl:max-w-full flex-[0_0_auto] rounded-[12px]  
              first-of-type:shadow-[0px_30px_30px_-18px_rgba(10,24,53,0.25)] p-[1px] mb-[1.875rem] 2xl:mb-12
