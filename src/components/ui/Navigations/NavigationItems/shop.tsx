...
const Shop = () => {
  ...
  const bodyStyles = [
    {
      label: "SUV",
      icon: <SUVIcon className="relative z-10 w-[24.87px] h-[9.61px] md:w-[44px] md:h-[17px]" />,
    },
    {
      label: "Truck",
      icon: <TruckIcon className="relative z-10 w-[24.87px] h-[9.31px] md:w-[44px] md:h-[17px]" />,
    },
    {
      label: "Sedan",
      icon: <SedanIcon className="relative z-10 w-[24.87px] h-[8.01px] md:w-[44px] md:h-[15px]" />,
    },
    {
      label: "Hatchback",
      icon: <HatchBackIcon className="relative z-10 w-[24.87px] h-[8.63px] md:w-[44px] md:h-[16px]" />,
    },
    {
      label: "Coupe",
      icon: <CoupeIcon className="relative z-10 w-[24.87px] h-[8.14px] md:w-[44px] md:h-[15px]" />,
    },
    {
      label: "Wagon",
      icon: <WagonIcon className="relative z-10 w-[24.87px] h-[8.04px] md:w-[44px] md:h-[15px]" />,
    },
    {
      label: "Minivan",
      icon: <MiniVanIcon className="relative z-10 w-[24.87px] h-[9.62px] md:w-[44px] md:h-[18px]" />,
    },
    {
      label: "Convertible",
      icon: <ConvertibleIcon className="relative z-10 fill-dark w-[24.87px] h-[7.49px] md:w-[44px] md:h-[14px]" />,
    },
  ];
      ...
      <div className="px-[15px] md:pl-[36px] lg:pl-[72px] mt-[20px] md:mt-0 w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 w-full gap-[12px] md:gap-[24px] ">
          {bodyStyles.map((style, index) => (
            <Card key={'bodystyle'+index} className="group md:max-h-[141px] md:max-w-[216px] group rounded-xl relative bg-white flex flex-col gap-[19px] justify-center items-start px-[12px] pt-[12px] md:pt-[30px] pb-[15px] md:pl-3 md:p-6  shadow-none border-[1px] md:gap-[38px] border-dark-5 hover:border-dark">
