...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center text-white justify-center px-4 py-2 text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50"
)
