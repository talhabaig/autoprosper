...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn("z-10 flex max-w-max flex-1", className)}
    {...props}
  >
    {children}
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center px-4 py-2 text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50"
);
...
>(({ className, children, variant = "light", ...props }, ref) => (
  ...
  >
    ...
    <div className="hidden group-data-[state=open]:block bg-green rounded-full absolute -bottom-[92%] w-[20%] h-[3px]">
      {/* Additional content for the 'dark' variant */}
    </div>
  </NavigationMenuPrimitive.Trigger>
));
