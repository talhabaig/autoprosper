    ...
    <>
      <div className="max-w-[940px] mx-auto md:my-[48px] my-6">
        ...
        <div className="flex flex-row justify-between md:justify-center gap-[12px]">
          <Button onClick={() => setType('brand')} variant="normal" size="sm" className="w-full md:w-auto border-[3px]">Brand</Button>
          <Button onClick={() => setType('type')} variant="outline" size="sm" className="w-full md:w-auto border-[3px]">Type</Button>
        </div>
      </div>
