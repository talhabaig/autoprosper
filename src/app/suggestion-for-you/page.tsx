...
import {
  FirstBuyerProvider,
  useFirstBuyer,
} from "@/components/Common/context/FirstTimeBuyerContext";
import { getCarSuggestions } from "../../components/FirstTimeBuyer/OpenAI";
...
const SuggestionForYou = () => {
  ...
  console.log("state in suggestion  for you", state);
      ...
      <section className="bg-dark-7 min-h-screen">
        ...
        <div className="container">
         ...
         xl:text-[1.25rem] xl:leading-[1.5]"
            >
              Explore these curated options we think will suit your preferences
              and needs.
            </p>
          </div>
          {loading ? (
              ...
              "
                >
                  <div className="h-full bg-white rounded-[12px]">
                    <Link className="block" href="product-detail">
                      <div
